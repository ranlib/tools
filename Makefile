...
#
variant_interpretation:
	docker build --no-cache -t dbest/variant_interpretation:v1.0.8 -f Dockerfile.variant_interpretation .
	#docker push dbest/variant_interpretation:v1.0.8 # push new version
...
#
lims_report:
	docker build --no-cache -t dbest/lims_report:v1.0.1 -f Dockerfile.lims_report .
